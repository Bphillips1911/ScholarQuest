...
export default function AdminResetPassword() {
  ...
  useEffect(() => {
    ...
    if (tokenParam) {
      ...
      setTimeout(() => setLocation("/admin-forgot-password"), 3000);
    }
  }, [toast, setLocation]);
  ...
  const resetMutation = useMutation({
    mutationFn: async (data: ResetPasswordForm) => {
      return await apiRequest("POST", "/api/admin/reset-password", {
        token,
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Your administrator password has been successfully updated. You can now log in with your new password.
                <br /><br />
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4" data-testid="admin-reset-password-section">
        ...
        <CardHeader className="text-center">
          ...
          <div className="flex justify-center mb-2">
            <div className="relative">
              ...
              <Lock className="h-4 w-4 text-blue-800 absolute -bottom-1 -right-1" />
            </div>
          </div>
          <CardTitle className="text-2xl font-bold school-name-3d">Create New Admin Password</CardTitle>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Password Requirements:</strong> Use at least 8 characters with a mix of letters, numbers, and symbols for better security. Administrator accounts require strong passwords.
                </AlertDescription>
              </Alert>
